...
namespace DirectX12Engine
{
	...
	public:
		...
		D3D12_GPU_VIRTUAL_ADDRESS GetCurrentFrameBufferGPUVirtualAddress() const
		{
			return GetCurrentFrameData()->GetGPUVirtualAddress(0);
		}
	...
	private:		
		...
		const std::unique_ptr<UploadBuffer<ResourceShaderDataType>>& GetCurrentFrameData() const
		{
