...
void DescriptorHeap::CreateDeviceDependentResources(const std::shared_ptr<DeviceResources>& deviceResources, size_t capacity, D3D12_DESCRIPTOR_HEAP_TYPE heapType, D3D12_DESCRIPTOR_HEAP_FLAGS heapFlags)
{
	m_capacity = capacity;
	m_count = 0;
	m_type = heapType;
...
INT DescriptorHeap::CreateConstantBufferView(const std::shared_ptr<DeviceResources>& deviceResources, const D3D12_CONSTANT_BUFFER_VIEW_DESC* description)
{
...
INT DescriptorHeap::CreateDepthStencilView(const std::shared_ptr<DeviceResources>& deviceResources, ID3D12Resource* resource, const D3D12_DEPTH_STENCIL_VIEW_DESC* description)
{
...
INT DescriptorHeap::CreateRenderTargetView(const std::shared_ptr<DeviceResources>& deviceResources, ID3D12Resource* resource, const D3D12_RENDER_TARGET_VIEW_DESC* description)
{
...
INT DescriptorHeap::CreateShaderResourceView(const std::shared_ptr<DeviceResources>& deviceResources, ID3D12Resource* resource, const D3D12_SHADER_RESOURCE_VIEW_DESC* description)
{
...
INT DescriptorHeap::CreateUnorderedAccessView(const std::shared_ptr<DeviceResources>& deviceResources, ID3D12Resource* resource, ID3D12Resource* counterResource, const D3D12_UNORDERED_ACCESS_VIEW_DESC* description)
{
