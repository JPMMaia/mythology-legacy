...
void ::DirectX12XamlApp::DirectXPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::DirectX12XamlApp::DirectXPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
    ...
    case 3:
        {
            ...
            (safe_cast<::Windows::UI::Xaml::Controls::AppBarButton^>(element3))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::DirectX12XamlApp::DirectXPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::DirectX12XamlApp::DirectXPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
