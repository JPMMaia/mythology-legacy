...
void App::Load(Platform::String^ entryPoint)
{
	if (m_main == nullptr)
	{
		m_main = std::unique_ptr<UniversalAppMain>(new UniversalAppMain());
	}
}
...
std::shared_ptr<GraphicsEngine::DeviceResources> App::GetDeviceResources()
{
	...
	if (m_deviceResources == nullptr)
	{
		...
		m_deviceResources->SetWindow(std::make_unique<Converters::NativeWindow>(CoreWindow::GetForCurrentThread()));
