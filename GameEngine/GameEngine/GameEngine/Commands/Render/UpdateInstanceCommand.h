...
namespace GameEngine
{
	...
	{
	public:
		UpdateInstanceCommand(RenderEngine::IScene& scene, const std::string& meshName, const std::shared_ptr<InstancedMeshComponent>& instance) :
			m_scene(scene),
			m_meshName(meshName),
			m_instance(instance)
		{
	...
	public:
		...
		{
			m_scene.UpdateInstance(m_meshName, *m_instance->GetInstanceData());
		}
