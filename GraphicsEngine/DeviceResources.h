...
namespace GraphicsEngine
{
	...
	public:
		...
		void SetCurrentOrientation(IWindow::DisplayOrientations currentOrientation);
	...
	private:
		...
		IWindow::DisplayOrientations	m_nativeOrientation;
		IWindow::DisplayOrientations	m_currentOrientation;
		float											m_dpi;
